...
export default {
  data() {
    return {
      ...
      password: '',
      themes: [
        { background: "#1A1A2E", color: "#000000", primaryColor: "#0F3460" },
        { background: "#461220", color: "#000000", primaryColor: "#E94560" },
        { background: "#192A51", color: "#000000", primaryColor: "#967AA1" },
        { background: "#F7B267", color: "#000000", primaryColor: "#F4845F" },
        { background: "#F25F5C", color: "#000000", primaryColor: "#642B36" },
        { background: "#231F20", color: "#000000", primaryColor: "#BB4430" }
      ],
    };
  },
  methods: {
    ...
    displayThemeButtons() {
      ...
      this.themes.forEach(theme => {
        ...
        div.style.cssText = `background: ${theme.background}; width: 25px; height: 25px; cursor: pointer; border-radius: 50%; margin: 5px;`;
...
<style scoped>
/* Add the CSS styles you provided here */
:root {
  --background: #1a1a2e;
  --color: #ffffff;
